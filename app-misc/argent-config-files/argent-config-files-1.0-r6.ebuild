...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="+dracut debug microcode plymouth +sddm vbox"
...
src_install() {
	...
	insinto /etc/systemd/resolved.conf.d/
	newins "${FILESDIR}"/00-argent-resolved.conf 00-argent.conf
}
