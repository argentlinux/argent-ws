...
AT_amd64="zulu8.54.0.21-jdk8.0.292-linux_x64.tar.gz"
...
SRC_URI="http://cdn.azul.com/zulu/bin/zulu8.54.0.21-ca-jdk8.0.292-linux_x64.tar.gz"
...
src_unpack() {
	...
	mkdir -p "${S}" || die
	mv "${WORKDIR}/zulu8.54.0.21-ca-jdk8.0.292-linux_x64"/* "${S}" || die
}
